...
export default async function TopMenuM() {
  ...
  return (
    <div className="flex fixed top-0 left-0 justify-between right-0 flex-row px-5 py-1.25 m-0 bg-white bg-opacity-50 h-12 z-50 shadow-lg w-full backdrop-blur-xl">
        ...
        <div className="flex flex-row align-center w-[200px]">
        ...
        <div className="flex flex-row-reverse items-center h-full top-0 font-sans w-[200px]">
          <Link href={"/mybooking"} ><Image src="/img/chart.png" className="w-auto mx-1.25 p-1" alt="myBooking" width={0} height={0} sizes="60vh"/></Link>
          {
